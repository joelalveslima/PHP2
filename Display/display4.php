...
<head>
    ...
    <title>Funcionário Comissão</title>
</head>
...
<body>
    ...
    $comissao =  new SalarioComissionado($nomeEmpre, $cpfEmpre, $inssEmpre, $idEmpre, $valorVendas, $valorComissao);
    ...
    <div>
        <?php
        $exibir = $comissao->exibirComissao();
