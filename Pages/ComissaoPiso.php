...
<head>
    ...
    <title>Salário Comissão Com Piso Salarial</title>
</head>

<body>
    <header>Funcionario Categoria Comissão Com Piso Salarial</header>
    <div>
        <form action="../Display/display5.php" method="post">
            ...
            <label>Piso Salarial</label><input type="text" name="pisosalario">
